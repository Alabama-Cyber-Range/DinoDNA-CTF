...
| 11 | `DINO{hashes_are_fingerprints}` | Hash functions | Solve the DNA fingerprint matching puzzle on **Security Audit** |
| 12 | `DINO{access_control_required}` | Access control | Awarded together with #4 on **/restricted-lab** |
